      ...
      <div style={styles.card}>
        <div style={styles.profileHeader}>
          ...
          <div>
            ...
            <p style={styles.profileRole}>Teacher · {profile?.uid}</p>
          </div>
        </div>
      </div>
...
const styles = {
  ...
  avatar: { width: '64px', height: '64px', borderRadius: '50%', backgroundColor: '#22c55e', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', fontWeight: '700' },
