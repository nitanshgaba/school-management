...
export default function TeacherEvents() {
    ...
    return (
      <div key={ev.id} onClick={() => setSelected(ev)} style={{ 
        ...
        <div style={{ ...styles.viewTag, color: ev.color || "#4f46e5" }}>
          Details <span style={{ marginLeft: '4px' }}>→</span>
        </div>
      </div>
    )
  }
  ...
  if (loading) return (
    <div style={styles.loadingBox}>
      ...
      <div style={{ color: '#64748b', fontWeight: '600' }}>Loading event calendar...</div>
    </div>
  )
  ...
  return (
    <div style={styles.container}>
      <div style={styles.pageHeader}>
        <div>
          <h1 style={styles.pageTitle}>Events & Activities</h1>
          <p style={styles.pageSubtitle}>Stay informed about upcoming school meets, holidays, and workshops</p>
        </div>
      </div>
      ...
      <div style={styles.fadeIn}>
        {upcoming.length > 0 && (
          <div style={{ marginBottom: "40px" }}>
            <h2 style={styles.sectionHead}>📅 Upcoming Schedule ({upcoming.length})</h2>
        ...
        {events.length === 0 && (
          <div style={styles.emptyState}>
            ...
            <h3 style={{ color: '#374151', margin: '0 0 8px 0' }}>No Events Logged</h3>
            <p style={{ color: '#6b7280', margin: 0 }}>There are no events scheduled for teachers at this time.</p>
          </div>
        )}
      </div>
            ...
            <div style={styles.modalContent}>
              {selected.description && (
                <div style={styles.descBox}>
                  <p style={styles.boxLabel}>Event Overview</p>
              ...
              <div style={styles.infoGrid}>
                ...
                {selected.venue && (
                  <div style={{ ...styles.infoCard, gridColumn: 'span 2' }}>
                    <p style={styles.boxLabel}>Venue Location</p>
...
const styles = {
  ...
  card: { backgroundColor: "#fff", borderRadius: "16px", padding: "24px", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.05), 0 2px 4px -1px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9", cursor: "pointer", transition: "all 0.2s ease" },
  ...
  modalTitle: { fontSize: "24px", fontWeight: "900", color: "#0f172a", margin: 0 },
