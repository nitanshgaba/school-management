...
//     'Chemistry','Biology','Computer Science','History','Geography','Economics',
//     'Civics','Physical Education','Art','Music','Information Technology',
//     'Accountancy','Business Studies','Environmental Science','Moral Science',
//     'French','Sanskrit','Punjabi','Drawing','General Knowledge','EVS'
//   ]
//   const dbNames = (data || []).map(s => s.name)
//   const allNames = [...new Set([...dbNames, ...standard])].sort()
//   setAllSubjects(allNames.map((name, i) => ({ id: `s_${i}`, name })))
// })
//   }, [])
...
//                 {allSubjects.map(s => <option key={s.id} value={String(s.id)}>{s.name}</option>)}
//               </select>
